    ...
    <Switch>
      ...
      
      {
        /*
          ...
          ANSWER HERE:
          The code below is used to navigate into tours new and edit page 
          where when clicked it redirects to tours page where user can choose to add or edit
          his/her tours after loging into their accounts.
